...
#define LOG_NUMBER(Variable, ...) ULog::Number(Variable, FString(#Variable) + ": ", __VA_ARGS__)
#define LOG_NUMBER_CONSOLE(Variable, ...) ULog::Number(Variable, #Variable, LO_Console)
#define LOG_NUMBER_VIEWPORT(Variable, ...) ULog::Number(Variable, #Variable, LO_Viewport)
